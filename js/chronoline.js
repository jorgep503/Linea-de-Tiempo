...
function Chronoline(domElement, events, options) {
    ...
    var defaults = {
        defaultStartDate: new Date(1589, 0, 1),  // the date furthest to the left on load. Defaults to today
        ...
        visibleSpan: DAY_IN_MILLISECONDS * 366 * 5,  // in milliseconds,
        timelinePadding: DAY_IN_MILLISECONDS * 366 / 4, // in ms. Adds this much time to the front and back to get some space
        ...
        eventHeight: 10,  // how tall event events are
    ...
    return date.getMonth() === 0 && date.getDate() === 1;
        ...
        labelFormat: "%Y",  // based on strftime

        subLabel: null,  // TODO generalize this code
        subLabelMargin: 2,
...
scrollRight: function(date) {
    return new Date(date.getFullYear() + 1, date.getMonth(), date.getDate());
        ...
        markToday: false,  // 'line', 'labelBox', false
        ...
        draggable: true, // requires jQuery, allows mouse dragging
